...
function setup() {
	...
	var ball_options = {
	  ...
	  ball2 = Bodies.circle(320,400,20,ball_options);
	  World.add(world,ball2);

	  ball3 = Bodies.circle(320,400,20,ball_options);
	  World.add(world,ball3);	

	  ball4 = Bodies.circle(320,400,20,ball_options);
	  World.add(world,ball4);

	  ball5 = Bodies.circle(320,400,20,ball_options);
